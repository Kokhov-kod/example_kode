// Nivelir_4Dlg.cpp : implementation file
//
...
CNivelir_4Dlg::CNivelir_4Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CNivelir_4Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CNivelir_4Dlg)
	m_edit1 = 0.0f;
	m_edit2 = 0.0f;
	m_edit3 = 0;
	m_edit4 = 0.0f;
...
void CNivelir_4Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CNivelir_4Dlg)
...
BEGIN_MESSAGE_MAP(CNivelir_4Dlg, CDialog)
	//{{AFX_MSG_MAP(CNivelir_4Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CNivelir_4Dlg message handlers
...
void CNivelir_4Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CNivelir_4Dlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CNivelir_4Dlg::OnOK() 
{
...
BEGIN_EVENTSINK_MAP(CNivelir_4Dlg, CDialog)
	...
	ON_EVENT(CNivelir_4Dlg, IDC_MSFLEXGRID1, -600 /* Click */, OnClickMsFlexgrid1, VTS_NONE)
	ON_EVENT(CNivelir_4Dlg, IDC_MSFLEXGRID1, -603 /* KeyPress */, OnKeyPressMsFlexgrid1, VTS_PI2)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()
