    ...
    <div class="header-top com">
        <div class="container">
            <div class="header-top-in grid-1">
                <ul class="support">
                    <li ><a href="mailto:info@example.com" ><i > </i>poddonerus@gmail.com</a></li>
...
<?php endif; ?>
            ...
            <div class="container">
                <div class="logo">
                    <h1><a href="index.php">PodDone</a></h1>
                </div>
                <div class="top-nav">

        <ul class="megamenu skyblue">
                        <!--<li><a  href="index.html">Главная</a></li>-->
                        <li><a  href="contact.html" style="color:#000;">Обратная связь</a></li>
                        <!--<li class="active grid"><a  href="#" style="color:red;">Магазин</a>-->
                        <li><a href="about.html" style="color:#000;">О нас</a></li>
                        <li><a href="products.php" style="color:#000;">Магазин</a></li>
                            <div class="megapanel">
                                <div class="row">
                                    <div class=" col-nav">
